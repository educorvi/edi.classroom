...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_chatroom_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='chatroom'
        )
        self.assertTrue(view.__name__ == 'chatroom')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in chatroom'
        # )

    def test_chatroom_not_matching_interface(self):
