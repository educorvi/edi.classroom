...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_klassenraum_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='klassenraum-view'
        )
        self.assertTrue(view.__name__ == 'klassenraum-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in klassenraum-view'
        # )

    def test_klassenraum_view_not_matching_interface(self):
