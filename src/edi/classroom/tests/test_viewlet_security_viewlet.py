...
class ViewletIntegrationTest(unittest.TestCase):
    ...
    def test_security_viewlet_is_registered(self):
        ...
        manager.update()
        my_viewlet = [v for v in manager.viewlets if v.__name__ == 'security-viewlet']  # NOQA: E501
        self.assertEqual(len(my_viewlet), 1)

    # XXX would be nice to have this test working:
    # def test_security_viewlet_is_not_available_on_newsitem(self):
