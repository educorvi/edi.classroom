...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_thema_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='thema-view'
        )
        self.assertTrue(view.__name__ == 'thema-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in thema-view'
        # )

    def test_thema_view_not_matching_interface(self):
